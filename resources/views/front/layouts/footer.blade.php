...
<style>
    ...
    .newsletter-btn:hover { background: var(--brand-dk); }
</style>
...
<footer class="site-footer">
        ...
        <div class="row g-4">
            ...
            <div class="col-lg-4 col-md-6">
                <div class="d-flex align-items-center gap-2 mb-3">
                    <div class="brand-icon" style="width:40px;height:40px;background:var(--brand);border-radius:8px;display:flex;align-items:center;justify-content:center;font-size:1.2rem;color:var(--dark);">
                        <i class="bi bi-box-seam-fill"></i>
                    </div>
                    <div class="footer-brand-name">Rent<span>Ease</span></div>
                </div>
                <p style="color:rgba(255,255,255,.5);font-size:.85rem;line-height:1.7;">
                    Your trusted partner for premium equipment rental. Quality gear, competitive rates, and outstanding service across the UK.
                </p>
            ...
            <div class="col-lg-2 col-md-6">
                ...
                <!-- <a class="footer-link" href="/"><i class="bi bi-chevron-right me-1" style="font-size:.7rem;"></i>Home</a>
                <a class="footer-link" href="#items"><i class="bi bi-chevron-right me-1" style="font-size:.7rem;"></i>Browse Equipment</a>
                <a class="footer-link" href="/cart"><i class="bi bi-chevron-right me-1" style="font-size:.7rem;"></i>My Cart</a>
            ...
            <div class="col-lg-3 col-md-6">
                ...
                <div class="footer-contact-item">
                    ...
                    <span>123 Rental Street, Birmingham, B1 1AA, United Kingdom</span>
                </div>
                <div class="footer-contact-item">
                ...
                <div class="footer-contact-item">
                    ...
                    <span>hello@rentease.co.uk</span>
                </div>
                <div class="footer-contact-item">
            ...
            <div class="col-lg-3 col-md-6">
                ...
                <p style="color:rgba(255,255,255,.5);font-size:.83rem;">Get exclusive deals and updates straight to your inbox.</p>
                ...
                <div class="d-flex gap-2 mt-4 flex-wrap">
                    <span style="background:rgba(255,199,0,.1);border:1px solid rgba(255,199,0,.2);border-radius:6px;padding:.3rem .65rem;font-size:.72rem;color:rgba(255,255,255,.6);">
    ...
    <div class="footer-bottom">
        <div class="container d-flex flex-column flex-md-row justify-content-between align-items-center gap-2">
            <span>&copy; 2026 <strong style="color:var(--brand);">RentEase</strong>. All rights reserved.</span>
