                ...
                <div class="modal-body">
                    ...
                    <div class="mb-3">
                        ...
                        <select id="request_product_type" class="form-select fw-bold" style="background:#f8f9fa;border-color:#ffc700;">
                            <option value="sell" {{ ($item->is_sell ?? true) ? 'selected' : '' }}> Selling Request </option>
                            <option value="rental" {{ ($item->is_rental ?? false) ? 'selected' : '' }}> Rental Request</option>
                        </select>
                    </div>
        ...
        async function submitRequest() {
            ...
            try {
                ...
                const response = await fetch('/guest-request', {
                    ...
                    body: JSON.stringify({
                        items: [{ id: document.getElementById('item_id').value, title: "{{ $item->title }}", type: reqType }],
