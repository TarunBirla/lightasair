...
.calc-row strong { color: var(--dark); }
            ...
            <div class="summary-card">
                ...
                <div class="summary-body">
                        ...
                        <div class="summary-item">
                            @if(isset($row['image']))
                                <img src="{{ asset('uploads/items/'.$row['image']) }}"
                                     class="summary-item-img" alt="{{ $row['title'] }}">
                            @else
                            ...
                            <div style="flex:1;min-width:0;">
                                ...
                                <div class="summary-item-meta">Qty: {{ $row['qty'] }} &bull; £{{ number_format($row['price'],2) }}/day</div>
                            </div>
                    ...
                    <div class="pt-3 pb-1">
                        ...
                        <div class="calc-row">
                            <span>Delivery</span>
                            <strong style="color:var(--success);"><i class="bi bi-check-circle-fill me-1"></i>Free</strong>
                        </div>
                    </div>
                </div>
